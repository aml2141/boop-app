...
{/* Names 3-5 with shared overlay */}
  ...
  <div className="text-center text-white">
    ...
    <p className="text-blue-100 text-sm md:text-lg mb-4 md:mb-8 max-w-md hidden md:block">Unlock to see complete meanings, popularity rankings, and personalized insights</p>
    <button
      onClick={handleGenerateMore}
